...
//callback functions need "export" on dos system, no affect in unix?
G_MODULE_EXPORT void on_btn_yes_clicked(GtkButton *b){
...
G_MODULE_EXPORT void on_btn_no_clicked(GtkButton *b){
